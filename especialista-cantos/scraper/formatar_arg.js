...
if (!fs.existsSync('raw_arg.json')) {
  console.log('Arquivo raw_arg.json não encontrado.');
  process.exit(1);
}

const raw = JSON.parse(fs.readFileSync('raw_arg.json', 'utf-8'));
...
const saidaStr = `// ============================================================
// DADOS DA LIGA PROFESIONAL ARGENTINA 2026 — MOTOR FANTASMA TMI
...
fs.writeFileSync('../data/argentina2026.js', saidaStr, 'utf-8');
console.log('✅ Arquivo ../data/argentina2026.js formatado com sucesso! Contém Estatísticas Táticas Injetadas (Posse e Chutes)!');
