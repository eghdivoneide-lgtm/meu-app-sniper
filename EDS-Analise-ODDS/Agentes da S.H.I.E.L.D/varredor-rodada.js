/**
 * Varredôr de Rodada v5 — Batch Processor Multi-Liga
 ...
 *   node varredor-rodada.js --liga J1
 *   node varredor-rodada.js --liga ALM
 *   node varredor-rodada.js --liga CHI
...
const LIGAS = {
  ...
  ALM: {
    ...
    times: 12,
    jogos_por_rodada: 6    // 12 times ÷ 2
  },
  CHI: {
    nome: 'Primera División (Chile)',
    url: 'https://www.flashscore.com/football/chile/primera-division/results/',
    times: 16,
    jogos_por_rodada: 8    // 16 times ÷ 2
  }
};
