/**
 * INJETOR — J2/J3 League rodada coletada 2026-05-16 (62 jogos)
 *
 * UPSERT por match_id em j2j3league2026.js do Especialista-Cantos.
 * Backup automático antes de gravar.
 *
 * Uso: node _injetar_j2j3_2026-05-16.js
 */
const fs = require('fs');
...
const LIGA = {
  codigo: 'J2J3',
  json:    'j2j3_rodada_2_2026-05-16.json',
  arquivo: 'j2j3league2026.js',
  varJS:   'DADOS_J2_J3'
};
...
console.log('═══════════════════════════════════════════════════════════════════');
console.log('  INJEÇÃO J2/J3 — Varredura 16/05/2026');
console.log('═══════════════════════════════════════════════════════════════════');
...
for (const alvo of alvos) {
  ...
  const out =
    '// ============================================================\n' +
    '// J2/J3 League 2026 — Injeção Varredor v4 (rodada 16/05/2026)\n' +
