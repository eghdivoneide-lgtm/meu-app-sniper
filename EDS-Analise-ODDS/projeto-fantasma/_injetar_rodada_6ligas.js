/**
 * INJETOR UNIVERSAL — Rodada 2026-04-23 (6 ligas)
 * UPSERT nos .js do Especialista-Cantos (ambas as cópias)
 * Uso: node _injetar_rodada_6ligas.js
 */
const fs   = require('fs');
...
const LIGAS = [
  { codigo: 'USL',   json: 'usl_rodada_2_2026-04-23.json',  arquivo: 'usl2026.js',          varJS: 'DADOS_USL'   },
  { codigo: 'ALM',   json: 'alm_rodada_2_2026-04-23.json',  arquivo: 'aleague2026.js',      varJS: 'DADOS_ALM'   },
  { codigo: 'CHI',   json: 'chi_rodada_2_2026-04-23.json',  arquivo: 'chile2026.js',        varJS: 'DADOS_CHI'   },
  { codigo: 'ECU',   json: 'ecu_rodada_2_2026-04-23.json',  arquivo: 'equador2026.js',      varJS: 'DADOS_ECU'   },
  { codigo: 'J1',    json: 'j1_rodada_2_2026-04-23.json',   arquivo: 'j1league2026.js',     varJS: 'DADOS_J1'    },
  { codigo: 'ARG_B', json: 'arg_b_rodada_2_2026-04-22.json',arquivo: 'argentina_b2026.js',  varJS: 'DADOS_ARG_B' },
];
...
// Filtro opcional via argv: node _injetar_rodada_6ligas.js J1 USL
...
for (const liga of ligasAlvo) {
  ...
  // Detectar caminhos dos arquivos alvo
  ...
  for (const alvo of alvos) {
    ...
    // Atualizar lista de times (union)
    ...
    const out =
      `// ============================================================\n` +
      `// ${liga.codigo} 2026 — Injeção Varredor v4 (upsert)\n` +
