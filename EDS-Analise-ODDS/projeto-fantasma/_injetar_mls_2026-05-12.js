/**
 * INJETOR — MLS rodada coletada em 2026-05-12 (15 jogos da rodada 09-10/05)
 *
 * UPSERT por match_id em mls2026.js do Especialista-Cantos.
 * Backup automático antes de gravar.
 *
 * Uso: node _injetar_mls_2026-05-12.js
 */
const fs = require('fs');
...
const LIGA = {
  codigo: 'MLS',
  json:    'mls_rodada_2_2026-05-12.json',
  arquivo: 'mls2026.js',
  varJS:   'DADOS_MLS'
};
...
console.log('═══════════════════════════════════════════════════════════════════');
console.log('  INJEÇÃO MLS — Rodada 09-10/05/2026');
console.log('═══════════════════════════════════════════════════════════════════');
